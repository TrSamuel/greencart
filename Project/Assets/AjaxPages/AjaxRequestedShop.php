                ...
                <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                           <img src="../Assets//Files//Shop//Photo/<?php echo $row['shop_photo'] ?>" alt="..." height="250" style="border-radius: 0.8em;">
                        </div>
                    ...
                    <p style="text-align: right;">
                        <a type="submit" class="btn " role="button" style="background: #026583;color: #fff;margin-right: 1em;" name="btn_accept" href="./AdminHomePage.php?Ashopid=<?php echo $row['shop_id'] ?>">Accept</a>
                        <a type="submit" class="btn " role="button" style="background: #830202;color: #fff;margin-right: 1em;" name="btn_reject" href="./AdminHomePage.php?Rshopid=<?php echo $row['shop_id'] ?>">Reject</a>
                    </p>
                </div>
            </div>
        </div>
