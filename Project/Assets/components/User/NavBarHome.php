<nav class="navbar navbar-expand  navbar-dark sticky-top px-4 py-0" style="background: #fff;" >
    ...
    <div class="d-none d-md-flex ms-4">
        <input id="searchplant" class="form-control  border-1" type="search" placeholder="Search Plant"
            style="background: #fff;" oninput="viewPlant(this.value)" <?php if ($search_name != '' || $search_name != null) { ?>
                value="<?php echo $search_name; ?>" <?php } ?>>
    </div>
    <div class="d-none d-md-flex ms-4">
            <img src="../Assets/Img/filter.png" alt="" style="height: 3em;" data-toggle="modal"
            data-target="#exampleModalCenter" onclick="applySearchValue()">
    </div>
...
<script>
    function applySearchValue(){
        document.getElementById('txtPlantName').value= document.getElementById('searchplant').value;   
