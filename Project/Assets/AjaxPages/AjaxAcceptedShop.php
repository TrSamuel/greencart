            ...
            <div class="card card-style1 border-0">
                <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                    ...
                    <p style="text-align: right;">
                        <a type="submit" class="btn " role="button" style="background: #830202;color: #fff;margin-right: 1em;" href="./AdminHomePage.php?Rshopid=<?php echo $row['shop_id'] ?>">Remove temporarily</a>
                    </p>
                </div>
            </div>
        </div>
